...
type CreateProductRequest struct {
	...
	Title       string        `bson:"title,omitempty" json:"title,omitempty" binding:"required,min=3,max=50"`
...
type PatchProductRequest struct {
	Title       *string   `bson:"title,omitempty" json:"title,omitempty" binding:"omitempty,min=3,max=50"`
	Description *string   `bson:"description" json:"description,omitempty" binding:"omitempty,min=10,max=500"`
	Price       *float64  `bson:"price" json:"price,omitempty" binding:"omitempty,number"`
	Category    *string   `bson:"category" json:"category,omitempty" binding:"omitempty"`
	SKU         *string   `bson:"sku,omitempty" json:"sku,omitempty"`
	Stock       *int      `bson:"stock,omitempty" json:"stock,omitempty" binding:"omitempty"`
	Images      *[]string `bson:"images,omitempty" json:"images,omitempty"`
	Tags        *[]string `bson:"tags,omitempty" json:"tags,omitempty"`
